...
linker.cmd: package/cfg/release_pem4.xdl
	$(SED) 's"^\"\(package/cfg/release_pem4cfg.cmd\)\"$""\"C:/Users/Daniel Schefer/workspace_v8/BabyMonitor_RTEmbedded_ZoharDaniel/.config/xconfig_release/\1\""' package/cfg/release_pem4.xdl > $@
